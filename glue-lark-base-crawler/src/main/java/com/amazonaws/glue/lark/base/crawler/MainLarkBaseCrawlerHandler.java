...
public class MainLarkBaseCrawlerHandler implements RequestHandler<Object, String>
{
    ...
    {
        this.larkBaseCrawlerHandler = requireNonNull(larkBaseCrawlerHandler, "larkBaseCrawlerHandler must not be null");
        this.larkDriveCrawlerHandler = requireNonNull(larkDriveCrawlerHandler, "larkDriveCrawlerHandler must not be null");
    }
    ...
    public String handleRequest(Object input, Context context)
    {
        ...
        if (requireNonNull(HandlerTypeEnum.fromString(convertInput.handlerType())) == HandlerTypeEnum.LARK_BASE) {
            logger.info("Handling Lark Base Crawler Request");
            return larkBaseCrawlerHandler.handleRequest(convertInput.payload(), context);
        }
        else if (requireNonNull(HandlerTypeEnum.fromString(convertInput.handlerType())) == HandlerTypeEnum.LARK_DRIVE) {
